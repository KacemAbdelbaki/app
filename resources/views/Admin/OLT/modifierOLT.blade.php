                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('olt.store') }}" method="POST">
                                        ...
                                        <div class="row mb-4">
                                            <label for="id" class="col-form-label col-lg-2">ID</label>
                                            <div class="col-lg-10">
                                                <input id="id" name="id" type="text" class="form-control" value="{{ $data->id }}" placeholder="Entrer l'ID">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="nom" class="col-form-label col-lg-2">Nom</label>
                                            <div class="col-lg-10">
                                                <input id="nom" name="nom" type="text" class="form-control" value="{{ $data->nom }}" placeholder="Entrer le nom">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="type" class="col-form-label col-lg-2">Type</label>
                                            <div class="col-lg-10">
                                                <input id="type" name="type" type="text" class="form-control" value="{{ $data->type }}" placeholder="Entrer le type">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="modele" class="col-form-label col-lg-2">Modèle</label>
                                            <div class="col-lg-10">
                                                <input id="modele" name="modele" type="text" class="form-control" value="{{ $data->modele }}" placeholder="Entrer le modèle">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-10">
                                                <input id="adresse" name="adresse" type="text" class="form-control" value="{{ $data->adresse }}" placeholder="Entrer l'adresse">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="centrale_optique" class="col-form-label col-lg-2">Centrale Optique</label>
                                            <div class="col-lg-10">
                                                <input id="centrale_optique" name="centrale_optique" type="text" class="form-control" value="{{ $data->centrale_optique }}" placeholder="Entrer la centrale optique">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="type_carte" class="col-form-label col-lg-2">Type de Carte</label>
                                            <div class="col-lg-10">
                                                <input id="type_carte" name="type_carte" type="text" class="form-control" value="{{ $data->type_carte }}" placeholder="Entrer le type de carte">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
